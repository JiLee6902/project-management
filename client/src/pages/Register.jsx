        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {password && (
              <div className="space-y-2 p-3 bg-zinc-50 dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800">
                ...
                <div className="space-y-1.5">
                  <div className={`flex items-center gap-2 text-sm ${passwordChecks.length ? 'text-zinc-700 dark:text-zinc-300' : 'text-zinc-400 dark:text-zinc-500'}`}>
                    <CheckCircle2 className={`h-4 w-4 ${passwordChecks.length ? 'text-zinc-700 dark:text-zinc-300' : 'text-zinc-300 dark:text-zinc-600'}`} />
                    At least 6 characters
                  </div>
                  {confirmPassword && (
                    <div className={`flex items-center gap-2 text-sm ${passwordChecks.match ? 'text-zinc-700 dark:text-zinc-300' : 'text-zinc-400 dark:text-zinc-500'}`}>
                      <CheckCircle2 className={`h-4 w-4 ${passwordChecks.match ? 'text-zinc-700 dark:text-zinc-300' : 'text-zinc-300 dark:text-zinc-600'}`} />
                      Passwords match
                    </div>
                  )}
                </div>
            ...
            <div className="flex items-start gap-3">
              <input
                ...
                type="checkbox"
                required
                className="mt-1 w-4 h-4 rounded border-zinc-300 dark:border-zinc-600 text-zinc-900 focus:ring-zinc-500"
              />
              <label htmlFor="terms" className="text-sm text-zinc-600 dark:text-zinc-400">
                I agree to the{' '}
                <button type="button" className="font-medium text-zinc-900 dark:text-white hover:underline">
                  Terms of Service
                </button>{' '}
                and{' '}
                <button type="button" className="font-medium text-zinc-900 dark:text-white hover:underline">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white dark:bg-zinc-950 text-zinc-500">or sign up with</span>
            </div>
          </div>
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          ...
          <h1 className="text-4xl font-bold leading-tight mb-6">
            Join thousands of
            <br />
            <span className="text-zinc-400">productive teams.</span>
          </h1>
          ...
          {/* Testimonial */}
          <div className="bg-zinc-800/50 backdrop-blur-sm border border-zinc-700/50 rounded-2xl p-6 max-w-md">
            ...
            <p className="text-zinc-300 mb-4">
              "Transformed how our team collaborates. We've increased productivity by 40% since switching."
            </p>
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-white font-medium">JiLee</p>
                <p className="text-zinc-500 text-sm">Product Manager at TechCorp</p>
              </div>
            </div>
          </div>
        </div>
